...
MODBUS_API void modbus_set_bits_from_byte_srv(uint8_t *dest, int idx, const uint8_t value);
MODBUS_API void modbus_set_bits_from_bytes(uint8_t *dest, int idx, unsigned int nb_bits,
                                       const uint8_t *tab_byte);
MODBUS_API void modbus_set_bits_from_bytes_srv(uint8_t *dest, int idx, unsigned int nb_bits,
                                       const uint8_t *tab_byte);
MODBUS_API uint8_t modbus_get_byte_from_bits(const uint8_t *src, int idx, unsigned int nb_bits);
MODBUS_API uint8_t modbus_get_byte_from_bits_srv(const uint8_t *src, int idx, unsigned int nb_bits);
...
MODBUS_API void set_bit(uint8_t * bit_array, int bit_no, bool value);
MODBUS_API bool get_bit(uint8_t * bit_array, int bit_no);
